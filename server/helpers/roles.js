...
const PIPELINE_ROLES = [ROLES.COLLABORATOR, ROLES.SUPER_COLLABORATOR, ROLES.SUPERVISOR, ROLES.DEPUTY];

// Roles that can create events
const EVENT_CREATOR_ROLES = [ROLES.ADMIN, ROLES.PROTOCOL, ROLES.DEPUTY, ROLES.SUPERVISOR, ROLES.SUPER_COLLABORATOR];

// Roles that can end events
const EVENT_ENDER_ROLES = [ROLES.ADMIN, ROLES.PROTOCOL, ROLES.DEPUTY, ROLES.SUPERVISOR];
